...
Footer -->
  ...
  <div class="hero-video">
    ...
    <div class="hero-text">
      <h1>Eat Well, Live Easy</h1>
      <p>
        Let ChopCorner handle the cooking. Enjoy mouthwatering meals, delivered hot and fresh,
        whenever hunger strikes. Your time, your taste, our kitchen.
      </p>
